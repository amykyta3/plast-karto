...
mkdir -p processed/OSIP_I_LiDAR
...
$LAStools/las2las -sp83 OH_N -feet -elevation_feet -i OSIP_I_GEA_LiDAR/N2365640.las -o tmp/N2365640.las
$LAStools/las2las -sp83 OH_N -feet -elevation_feet -i OSIP_I_GEA_LiDAR/N2365645.las -o tmp/N2365645.las
$LAStools/las2las -sp83 OH_N -feet -elevation_feet -i OSIP_I_GEA_LiDAR/N2370640.las -o tmp/N2370640.las
$LAStools/las2las -sp83 OH_N -feet -elevation_feet -i OSIP_I_GEA_LiDAR/N2370645.las -o tmp/N2370645.las
...
# Rasterize for QGIS
wine $LAStools/las2dem -i tmp/pk-height.las -o processed/OSIP_I_LiDAR/veg-heightmap.jpg -false -kill 5

#-------------------------------------------------------------------------------
# Generate hill shading image
wine $LAStools/las2dem -i tmp/elev-ft.las -o processed/OSIP_I_LiDAR/hillshade.png -hillshade

# Generate ground intensity raster
wine $LAStools/las2dem -i tmp/elev-ft.las -o processed/OSIP_I_LiDAR/ground-intensity.jpg -intensity

#-------------------------------------------------------------------------------
# Generate isocontours from ground elevation data

wine $LAStools/las2iso -i tmp/elev-ft.las -o processed/OSIP_I_LiDAR/iso-5ft.shp -iso_every 5 -smooth 2 -clean 100
wine $LAStools/las2iso -i tmp/elev-m.las -o processed/OSIP_I_LiDAR/iso-1m.shp -iso_every 1 -smooth 1 -clean 30
