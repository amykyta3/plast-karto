...
if __name__ == "__main__":
    ...
    with QgisSession():
        ...
        export_map(
            os.path.join(this_dir, 'VovchaTropa-greyscale.qgs'),
            "8.5x11",
            os.path.join(this_dir, "rendered/VovchaTropa-greyscale-8.5x11.pdf"),
            os.path.join(this_dir, "rendered/VovchaTropa-greyscale-8.5x11-thumb.png"),
        )
