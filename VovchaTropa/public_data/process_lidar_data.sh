...
$LAStools/las2las -keep_xy 621500 4693200 623400 4694700 -i tmp/merged.las -o tmp/cropped.las
$LAStools/las2las -keep_xy 621510 4693200 623400 4694700 -i tmp/merged.las -o tmp/cropped-shifted.las
